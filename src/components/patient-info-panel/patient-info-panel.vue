            ...
            <div class="form-row">
              ...
              <div class="col-md-4">
                ...
                <b-dropdown
                  ...
                  :text="genders[patient_gender]"
                >
                  <b-dropdown-item
                    v-for="value, key in genders"
                    :value="value"
                    :key="key"
                    @click="patient_gender = key"
                ...
                <b-form-group>
                  <div class="form-row">
                    <div class="col-md-12">
                      ...
                      <b-form-input type="text" v-model="patient_address" class="mb-2" required />
                      <b-form-input type="text" v-model="patient_address_2" required />
                    </div>
                  </div>
                </b-form-group>
              </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <b-form-group>
                  ...
                  <b-form-input type="text" required v-model="patient_city" />
                </b-form-group>
              </div>
              <div class="col-md-3">
                <b-form-group>
                  <label>State <span class="required">*</span></label>
                  <b-dropdown class="state-dropdown" v-model="patient_state" text="UT">
              ...
              <div class="col-md-3">
                <b-form-group>
                  ...
                  <b-form-input type="text" required v-model="patient_zipcode"/>
                </b-form-group>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <b-form-group>
                  ...
                  <b-form-input :value="patient_phone" type="text" required />
                </b-form-group>
              </div>
              <div class="col-md-6">
                <b-form-group>
                  <label>Email</label>
                  <b-form-input :value="patient_email" type="email" required />
                </b-form-group>
              </div>
              <div class="col-md-4">
                <b-form-group>
